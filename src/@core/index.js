...
const isNight = new Date().getHours() < 7 || new Date().getHours() > 18

export const defineThemeConfig = userConfig => {

  prefersDarkMode || isNight ? localStorage.setItem(`${userConfig.app.title}-theme`, 'dark') : localStorage.setItem(`${userConfig.app.title}-theme`, 'light')
